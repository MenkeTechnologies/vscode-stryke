// Pure (vscode-free) resolver for the stryke binary, factored out of
...
// the editor's process does NOT inherit the shell PATH, so a bare `stryke`
...
// Resolve `configured` (the `stryke.path` setting, default "stryke") to an
...
function resolveStrykeBinary(configured, fallbackDirs = defaultFallbackDirs()) {
...
module.exports = { resolveStrykeBinary, defaultFallbackDirs };
